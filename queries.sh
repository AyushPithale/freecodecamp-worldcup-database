...
echo   "$($PSQL "SELECT name FROM teams LEFT JOIN games ON  teams.team_id = games.winner_id OR games.opponent_id = teams.team_id WHERE round='Eighth-Final' AND year='2014' GROUP BY name ")"
